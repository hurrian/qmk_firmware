...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // IBM Model M 122-key for hurrian
  [0] = LAYOUT(
    ...
    KC__VOLUP,   KC_MNXT, KC_CAPS, KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,    KC_SCLN, KC_QUOT, KC_BSLS,                     KC_UP,               KC_P4,   KC_P5,   KC_P6,   KC_PENT,
    ...
    KC__MUTE,    KC_MPRV, KC_LCTL, KC_LGUI,                                        KC_SPC,                           KC_LALT, KC_RCTL,                     KC_NO,               KC_P0,            KC_PDOT
  ),
};
